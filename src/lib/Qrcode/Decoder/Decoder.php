...
class Decoder {
     ...
     * @param null $hints
     * @throws  Exception
     * @return DecoderResult|text|string
     */
     ...
     *
     * @param $image array. booleans representing white/black QR Code modules
     * @param $hints null. decoding hints that should be used to influence decoding
