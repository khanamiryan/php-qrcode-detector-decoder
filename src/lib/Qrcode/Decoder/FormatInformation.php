...
final class FormatInformation {
    ...
    static function numBitsDiffering($a, $b) {
        ...
        self::$BITS_SET_IN_HALF_BYTE[intval($common->uRShift($a, 4) & 0x0F)] +
        self::$BITS_SET_IN_HALF_BYTE[($common->uRShift($a ,8) & 0x0F)] +
        self::$BITS_SET_IN_HALF_BYTE[($common->uRShift($a , 12) & 0x0F)] +
        self::$BITS_SET_IN_HALF_BYTE[($common->uRShift($a, 16) & 0x0F)] +
        self::$BITS_SET_IN_HALF_BYTE[($common->uRShift($a , 20) & 0x0F)] +
        self::$BITS_SET_IN_HALF_BYTE[($common->uRShift($a, 24) & 0x0F)] +
        self::$BITS_SET_IN_HALF_BYTE[($common->uRShift($a ,28) & 0x0F)];
    }
     ...
     * @return FormatInformation information about the format it specifies, or {@code null}
